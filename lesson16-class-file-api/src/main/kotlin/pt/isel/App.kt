...
fun buildClassBar() {
        ...
        of()
            ...
            clb
                ...
                .withMethod(INIT_NAME, MTD_void, ACC_PUBLIC) { mb ->
                    ...
                    mb.withCode { cob ->
                        cob
                            .ldc(Integer.valueOf(67896) as Integer)
    ...
    // /Users/luisfalcao/Cloud Drives/NAS-LF/ISEL/Disciplinas/2025_2026/2025-2026VerLAE/Repositories/2026-lae-43d-LF/lesson16-class-file-api/pt/isel/Bar.class
...
fun buildCounter() {
    ...
    File(resourcePath, className.replace('.', '/') + ".class")
        ...
        .also { println("Full file name: ${it.path}")}
